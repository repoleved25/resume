...
\item {\bf Development:} JAVA, C/C++, Android, \LaTeX
...
\item
	\ressubheading{Snapdeal}{Bengaluru, IN}{Software Developement Engineer (User Generated Content Team)}{July 2015 - current}
	\begin{itemize}
            \resitem{{\bf Reviews and Ratings:} Worked Extensively on the BackEnd Tasks of Reviews and Ratings System}
