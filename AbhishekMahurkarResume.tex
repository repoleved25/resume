...
\item
	...
	\begin{itemize}
		...
		\begin{comment}
		\resitem{Data Structures and Algorithms, Information Reteival,Cloud Computing}
		\end{comment}
	\end{itemize}
...
\item {\bf Development:} JAVA, C/C++, JavaScript, HTML, Android, \LaTeX
...
\item
	\ressubheading{Snapdeal}{Bengaluru, IN}{Software Developement Engineer (UGC Team)}{July 2015 - current}
	\begin{itemize}
            \resitem{{\bf Reviews and Ratings:} Co-developed and led team for MOE: the Metric Optimization Engine (\texttt{github.com/Yelp/MOE}, an \textbf{open source} optimization framework), found significant gains in different metrics across the organization using Bayesian Global Optimization algorithms.Some text to adjust Ipsum loren Some text to adjust Ipsum loren Some text to adjust Ipsum loren.}
            \resitem{{\bf Questions and Answers:} As a Backend Developer Worked on Developing and Optimizing API's }
